    ...
    <div style={styles.page}>
      <div style={styles.card}>
        ...
        <div style={styles.grid}>
          ...
          <ProfileField icon={<Book size={18} />} label="Course" value={user.course ? <Link to={`/course/${user.course.id}`} style={{ color: "#2563eb", fontWeight: "600", textDecoration: "none" }}>{user.course_name}</Link> : "N/A"} />
